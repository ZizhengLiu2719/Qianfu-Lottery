...
class _CoursesScreenState extends ConsumerState<CoursesScreen> {
  ...
  Widget _buildWelcomeContent(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        SizedBox(height: isDesktop ? 2.h : 16.h),
        Text(
          AppLocalizations.of(context)!.learning_title,
          style: TextStyle(
            fontSize: isDesktop ? 8.sp : 18.sp,
            fontWeight: FontWeight.bold,
            color: AppTheme.textPrimary,
          ),
        ),
        SizedBox(height: isDesktop ? 1.h : 8.h),
        Text(
        ...
        SizedBox(height: isDesktop ? 4.h : 24.h),
        _buildCategoryCard(
          context,
        ...
        SizedBox(height: isDesktop ? 2.h : 12.h),
        _buildCategoryCard(
          context,
